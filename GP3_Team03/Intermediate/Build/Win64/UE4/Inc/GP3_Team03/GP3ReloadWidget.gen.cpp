...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_StartDelayTime_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_StartDelayTime;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGP3ReloadWidget_Statics::NewProp_StartDelayTime_MetaData[] = {
		{ "Category", "GP3ReloadWidget" },
		{ "ModuleRelativePath", "Public/Widgets/GP3ReloadWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGP3ReloadWidget_Statics::NewProp_StartDelayTime = { "StartDelayTime", nullptr, (EPropertyFlags)0x0040000000010001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGP3ReloadWidget, StartDelayTime), METADATA_PARAMS(Z_Construct_UClass_UGP3ReloadWidget_Statics::NewProp_StartDelayTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGP3ReloadWidget_Statics::NewProp_StartDelayTime_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGP3ReloadWidget_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGP3ReloadWidget_Statics::NewProp_StartDelayTime,
	};
	...
	IMPLEMENT_CLASS(UGP3ReloadWidget, 3597695105);
