...
// End Cross Module References
	...
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_AmountOfEnemies);
		P_GET_OBJECT(UClass,Z_Param_EnemyType);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SpawnEnemies(Z_Param_AmountOfEnemies,Z_Param_EnemyType);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_ASpawningEnemySystem_SpawnEnemies_Statics
	{
		...
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_AmountOfEnemies;
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ASpawningEnemySystem_SpawnEnemies_Statics::NewProp_AmountOfEnemies = { "AmountOfEnemies", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpawningEnemySystem_eventSpawnEnemies_Parms, AmountOfEnemies), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASpawningEnemySystem_SpawnEnemies_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASpawningEnemySystem_SpawnEnemies_Statics::NewProp_AmountOfEnemies,
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Amount2_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Amount2;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASpawningEnemySystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpawningEnemySystem_SpawnEnemies, "SpawnEnemies" }, // 2198368512
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_EnemyToSpawn = { "EnemyToSpawn", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpawningEnemySystem, EnemyToSpawn), Z_Construct_UClass_AGP3_AI_BaseCharacter_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_EnemyToSpawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_EnemyToSpawn_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount = { "Amount", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpawningEnemySystem, Amount), METADATA_PARAMS(Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount2_MetaData[] = {
		{ "Category", "Enemies" },
		{ "ModuleRelativePath", "Public/AI/SpawningEnemySystem.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount2 = { "Amount2", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpawningEnemySystem, Amount2), METADATA_PARAMS(Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount2_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount2_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpawningEnemySystem_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpawningEnemySystem_Statics::NewProp_Amount2,
	...
	IMPLEMENT_CLASS(ASpawningEnemySystem, 3528554338);
