...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGP3CrosshairWidget_Statics::NewProp_PlayerPawn_MetaData[] = {
		{ "ModuleRelativePath", "Public/Widgets/GP3CrosshairWidget.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGP3CrosshairWidget_Statics::NewProp_PlayerPawn = { "PlayerPawn", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGP3CrosshairWidget, PlayerPawn), Z_Construct_UClass_AGP3PlayerPawn_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGP3CrosshairWidget_Statics::NewProp_PlayerPawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGP3CrosshairWidget_Statics::NewProp_PlayerPawn_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGP3CrosshairWidget_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGP3CrosshairWidget_Statics::NewProp_PlayerPawn,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGP3CrosshairWidget_Statics::ClassParams = {
		...
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_UGP3CrosshairWidget_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		UE_ARRAY_COUNT(FuncInfo),
		UE_ARRAY_COUNT(Z_Construct_UClass_UGP3CrosshairWidget_Statics::PropPointers),
		0,
		0x00B010A0u,
	...
	IMPLEMENT_CLASS(UGP3CrosshairWidget, 4249035225);
