...
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DashFov;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DashFovSpeedStart_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DashFovSpeedStart;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DashFovSpeedStop_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DashFovSpeedStop;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFov = { "DashFov", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGP3PlayerSpringArmComponent, DashFov), METADATA_PARAMS(Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFov_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFov_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFovSpeedStart_MetaData[] = {
		{ "Category", "CameraDashSettings" },
		{ "Comment", "/** Speed of camera FOV changing. Higher = faster. */" },
		{ "ModuleRelativePath", "Public/Player/GP3PlayerSpringArmComponent.h" },
		{ "ToolTip", "Speed of camera FOV changing. Higher = faster." },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFovSpeedStart = { "DashFovSpeedStart", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGP3PlayerSpringArmComponent, DashFovSpeedStart), METADATA_PARAMS(Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFovSpeedStart_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFovSpeedStart_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGP3PlayerSpringArmComponent_Statics::NewProp_DashFovSpeedStop_MetaData[] = {
		{ "Category", "CameraDashSettings" },
		{ "ModuleRelativePath", "Public/Player/GP3PlayerSpringArmComponent.h" },
	};
#endif
